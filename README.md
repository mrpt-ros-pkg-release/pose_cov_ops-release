## pose_cov_ops (noetic) - 0.3.13-1

The packages in the `pose_cov_ops` repository were released into the `noetic` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r noetic pose_cov_ops` on `Sat, 26 Oct 2024 18:38:25 -0000`
...
## pose_cov_ops (noetic) - 0.3.12-1

The packages in the `pose_cov_ops` repository were released into the `noetic` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r noetic pose_cov_ops` on `Tue, 27 Aug 2024 06:42:57 -0000`
...
## pose_cov_ops (noetic) - 0.3.11-1

The packages in the `pose_cov_ops` repository were released into the `noetic` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y --ros-distro noetic pose_cov_ops` on `Mon, 18 Sep 2023 07:55:19 -0000`
...
## pose_cov_ops (melodic) - 0.3.10-1

The packages in the `pose_cov_ops` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --rosdistro melodic pose_cov_ops -y` on `Fri, 07 Apr 2023 16:55:48 -0000`
...
## pose_cov_ops (noetic) - 0.3.10-1

The packages in the `pose_cov_ops` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --rosdistro noetic pose_cov_ops -y` on `Fri, 07 Apr 2023 16:54:26 -0000`
...
## pose_cov_ops (melodic) - 0.3.9-1

The packages in the `pose_cov_ops` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --ros-distro melodic pose_cov_ops -y` on `Sat, 01 Apr 2023 01:24:41 -0000`
...
## pose_cov_ops (noetic) - 0.3.9-1

The packages in the `pose_cov_ops` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --ros-distro noetic pose_cov_ops -y` on `Sat, 01 Apr 2023 01:23:46 -0000`
...
## pose_cov_ops (melodic) - 0.3.8-1

The packages in the `pose_cov_ops` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -y --ros-distro melodic pose_cov_ops` on `Tue, 06 Sep 2022 09:38:44 -0000`
